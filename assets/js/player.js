				...
				if(is_ep_premium_only == true) {
					...
					$.ajax({
						...
						success: function (result,status,xhr) {
							...
							var video_1080p_mp4_url = video_1080p_mp4_url_old.replace("f.v.vrv.co", "v.vrv.co");
					...
					$.ajax({
						...
						success: function (result,status,xhr) {
							...
							var video_720p_mp4_url = video_720p_mp4_url_old.replace("f.v.vrv.co", "v.vrv.co");
					...
					$.ajax({
						...
						success: function (result,status,xhr) {
							...
							var video_480p_mp4_url = video_480p_mp4_url_old.replace("f.v.vrv.co", "v.vrv.co");
					...
					$.ajax({
						...
						success: function (result,status,xhr) {
							...
							var video_360p_mp4_url = video_360p_mp4_url_old.replace("f.v.vrv.co", "v.vrv.co");
					...
					$.ajax({
						...
						success: function (result,status,xhr) {
							...
							var video_240p_mp4_url = video_240p_mp4_url_old.replace("f.v.vrv.co", "v.vrv.co");
