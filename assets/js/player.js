		...
		complete: function (response) {
			...
			function download_ButtonClickAction() {
				...
				if(is_ep_premium_only == true) {
					var video_1080p_dash_playlist_url_no_clipe = video_m3u8_array[1].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['id'] + "/index.m3u8", "?Expires=1616675412&");
					...
					var video_720p_dash_playlist_url_no_clipe = video_m3u8_array[0].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['id'] + "/index.m3u8", "?Expires=1616675412&");
					...
					var video_480p_dash_playlist_url_no_clipe = video_m3u8_array[2].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['id'] + "/index.m3u8", "?Expires=1616675412&");
					...
					var video_360p_dash_playlist_url_no_clipe = video_m3u8_array[3].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['id'] + "/index.m3u8", "?Expires=1616675412&");
					...
					var video_240p_dash_playlist_url_no_clipe = video_m3u8_array[4].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['id'] + "/index.m3u8", "?Expires=1616675412&");
